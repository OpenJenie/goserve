...
Contributor onboarding starts in [CONTRIBUTING.md](/Users/admin/Projects/opensource/org/goserve/CONTRIBUTING.md). Starter-friendly tasks should live in GitHub Issues under the `good first issue` label.
